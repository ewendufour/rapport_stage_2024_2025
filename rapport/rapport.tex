...
\newtheorem{theorem}{Théorem}[section]
...
\begin{enumerate}
    ...
    \item Des structures de données pour les différentes entrées de la machine.
...
\end{align*}
Nous partons du principe que les termes avant encodage sont sous la forme indice de de Bruijn et les variables sont écrit en base 2. Nous avons ajouté un symbole $A$ pour délimiter la fin d'une abstraction et un symbole $S$ pour définir le début d'une substitution explicite. Enfin, nous ajoutonsl des parenthèse et un symbole d'espace aux applications pour délimiter chaque membres. Il est direct que notre encodage à une taille linéaire en la taille du terme non encodé.
...
Pour toutes les raisons énoncées, nous conjecturons que la proposition suivante est vraie.
\begin{proposition}
