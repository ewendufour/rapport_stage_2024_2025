...
\begin{proof}
  ...
  \underbar{Cas $\mathcal{C} = \square$~:} immédiat.\\
  \underbar{Cas $\mathcal{C} = \mathcal{C}_1[x/v]$~:}\\
  \begin{align*}
  ...
  \end{align*}
  \underbar{Cas $\mathcal{C} = \mathcal{C}_1~u$~:}\\
  \begin{align*}
  ...
  \end{align*}
  \underbar{Cas $\mathcal{C} = v~\mathcal{C}_1$~:}\\
  \begin{align*}
...
\begin{lemma}
  ...
  $\mathcal{C}[t]$ propre $\Rightarrow \langle -, t, \mathcal{C}:: \mathcal{D}\rangle_2 \rightsquigarrow^* \langle -, \mathcal{C}[t], \mathcal{D}\rangle_2$
\end{lemma}
\begin{proof}
  Par induction sur la forme de $\mathcal{C}$.\\
  \underbar{Cas $\mathcal{C} = \square$~:} immédiat.\\
 ...
 &\Rightarrow \mathcal{C}_1[t]~\text{propre}
  ...
  \end{align*}
  \underbar{Cas $\mathcal{C} = v~\mathcal{C}_1$~:} Analogue au cas précédent.\\
\end{proof}
