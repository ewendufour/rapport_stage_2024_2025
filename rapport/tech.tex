  ...
  \begin{itemize}
    \item \underbar{Cas LS~:} Nous avons $\mtc\llbracket x\rrbracket[x/v]\rightarrow \mtc[v][x/v]$ sous hypothèse que $x\in fv(\mtc[v])$. Donc $S = |\mtc|+2\times|v|$.\\
      \begin{tabular}{@{}l c c c@{}}
        ...
        $\rightarrow_{us}$ & $ \etatz{-, \mtc\llbracket x \rrbracket, \square[x/v]::\mtd}$ & $|\mtd| + |v| + |\mtc|+|x|$\\ 
        $\rightarrow^*$ & $ \etatz{-, x ,\mtc:: \square[x/v]::\mtd}$ & $|\mtd| + |v| + |\mtc|+|x|$& Lemme \ref{lemmaplouf}\\
        $\rightarrow_{ls}$ & $ \etatd{-, v ,\mtc:: \square[x/v]::\mtd}$ & $|\mtd| + |v| + |\mtc|+|v|$\\
        $\rightarrow^*$ & $ \etatd{-, \mtc[v], \square[x/v]::\mtd}$ & $|\mtd| + |v| + |\mtc|+|v|$ &Lemme \ref{lemmaportugal}\\ 
        $\rightarrow_{bsubst}$ & $ \etatd{-, \mtc[v][x/v], \mtd}$ & $|\mtd| + |v| + |\mtc|+|v|$&$x\in fv(\mtc[v])$\\ 
        \bottomrule
      \end{tabular}\\
    ...
    \item \underbar{Cas LSGC~:} Nous avons $\mtc\llbracket x\rrbracket[x/v]\rightarrow \mtc[v]$ avec comme hypothèse que $x\notin fv(\mtc[v])$. Donc $S = |\mtc|+|x|+|v|$.\\
      \begin{tabular}{@{}l c c c@{}}
        ...
        $\rightarrow_{ls}$ & $ \etatd{-, v ,\mtc:: \square[x/v]::\mtd}$ & $|\mtd| + |v| + |\mtc|+|v|$\\
        $\rightarrow^*$ & $ \etatd{-, \mtc[v], \square[x/v]::\mtd}$ & $|\mtd| + |v| + |\mtc| +|v|$ &Lemme \ref{lemmaportugal}\\ 
        $\rightarrow_{gc}$ & $ \etatd{-, \mtc[v], \mtd}$ & $|\mtd| + |v| + |\mtc|$& $x\notin fv(\mtc[v])$\\ 
        \bottomrule
      \end{tabular}\\
